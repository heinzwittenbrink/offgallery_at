...
class SlideShow extends s {
  ...
  render() {
    const chevronRight = b`<svg style="transform: translateX(1px)" xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960">
      <path d="M504-480 320-664l56-56 240 240-240 240-56-56 184-184Z"/>
    </svg>`;
    const chevronLeft = b`<svg style="transform: rotate(180deg) translateX(1px)" xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960">
      <path d="M504-480 320-664l56-56 240 240-240 240-56-56 184-184Z"/>
    </svg>`;
    return x`
      <div class="wrapper">
        ...
        <nav>
          ...
          this.visiblePage != null &&
          this.totalPages != null
            ? x`<span>${this.visiblePage} / ${this.totalPages}</span>`
            : x``}
          ${this.controls
            ? x`<button
